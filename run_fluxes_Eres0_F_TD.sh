...
m4 -D ER=0 -D N=2 -D Z=20 -D TF=False config.m4 > ERES0_F_TD.cfg
python create_fluxes.py ERES0_F_TD.cfg ERES0_F_TD
python Statistics.py ERES0_F_TD_H0H1_m0.1_zmax20_n2_alpha2_ZdecayTrue.txt
...
# submit script
qsub -N CnuB_fluxes_ERES0_F_TD -q ${QUEUE} -V -j oe  -m be -M rasam@nikhef.nl ./$SCRIPTNAME
