...
m4 -D ER=0 -D N=4 -D Z=2 -D TF=True config.m4 > ERES30_FE_BU.cfg
python create_fluxes.py ERES30_FE_BU.cfg ERES30_FE_BU
python Statistics.py ERES30_FE_BU_H0H1_m0.1_zmax2_n4_alpha2_ZdecayTrue.txt
...
# submit script
qsub -N CnuB_fluxes_ERES30_FE_BU -q ${QUEUE} -V -j oe  -m be -M rasam@nikhef.nl ./$SCRIPTNAME
