...
m4 -D ER=0 -D N=6 -D Z=20 -D TF=True config.m4 > ERES80_FE_OPT.cfg
python create_fluxes.py ERES80_FE_OPT.cfg ERES80_FE_OPT
python Statistics.py ERES80_FE_OPT_H0H1_m0.1_zmax20_n6_alpha2_ZdecayTrue.txt
...
# submit script
qsub -N CnuB_fluxes_ERES80_FE_OPT -q ${QUEUE} -V -j oe  -m be -M rasam@nikhef.nl ./$SCRIPTNAME
