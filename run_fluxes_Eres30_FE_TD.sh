...
m4 -D ER=0 -D N=2 -D Z=20 -D TF=True config.m4 > ERES30_FE_TD.cfg
python create_fluxes.py ERES30_FE_TD.cfg ERES30_FE_TD
python Statistics.py ERES30_FE_TD_H0H1_m0.1_zmax20_n2_alpha2_ZdecayTrue.txt
...
# submit script
qsub -N CnuB_fluxes_ERES30_FE_TD -q ${QUEUE} -V -j oe  -m be -M rasam@nikhef.nl ./$SCRIPTNAME
